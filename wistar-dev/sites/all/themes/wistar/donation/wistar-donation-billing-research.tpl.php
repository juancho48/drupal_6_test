<?php //$donation_billing_research_form = drupal_get_form('wistar_donation_billing_research_form'); ?>
<?php //pa($donation_billing_research_form,1); ?>
		...
		<div class="content">
			...
			<div id="node-<?php print $node->nid;?>" class="node page node-page">
				<div class="section">
					...
					<?php print $donation_billing_research_form; ?>
				</div>
			</div>
		</div>
	</div>
