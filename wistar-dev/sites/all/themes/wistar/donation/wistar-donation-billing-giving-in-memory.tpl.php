<?php $donation_billing_giving_in_memory_form = drupal_get_form('wistar_donation_billing_giving_in_memory_form'); ?>
<div id="init-give-forms"></div>
<?php //pa($node->field_masthead_image,1); ?>
		...
		<div class="content">			
			...
			<div id="node-<?php print $node->nid;?>" class="node page node-page">
				<div class="section">
					...
					<?php print $donation_billing_giving_in_memory_form; ?>
				</div>
			</div>
		</div>
	</div>
